...
/* Carrusel con fade y puntos indicadores */
...
/************** Fondo del video promocional section ******************/
const COUNT = 1100;
const SPEED = 2.75;
...
function resize() {
    const section = canvas.parentElement; /* ← sección, no window */
...
/* También cambia esto para que el mouse sea relativo a la sección */
window.addEventListener("pointermove", (e) => {
    const section = canvas.parentElement;
    const rect = section.getBoundingClientRect();
    mx = ((e.clientX - rect.left) / w) * 2 - 1;
});
